...
def step1_process_and_move():
    ...
    for cat in categories:
        ...
        target_lib = os.path.join(LIBRARY_ROOT, normalize_text(cat))
        ...
        for item in os.listdir(cat_staging):
            ...
            dest_path = os.path.join(target_lib, normalize_text(item))
...
# ==========================================
# 📊 STEP 2: สร้าง DB + ปกรายไฟล์ + ปกโฟลเดอร์ (เพิ่มฟังก์ชันยุบรวมหมวดหมู่ _Vol)
# ==========================================
...
if __name__ == '__main__':
    ...
    reset_log()
    log('▶️ เริ่มระบบจัดการคลังหนังสือรันนารา (Repair Cover Edition + Auto-Collapse Vol)')
    ...
    log('\n✨ ทำงานเสร็จสมบูรณ์ ทุกอย่างอัปเดตเป็นปัจจุบันและจัดกลุ่มเรียบร้อยแล้วครับ!')