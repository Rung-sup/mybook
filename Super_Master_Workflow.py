        ...
        for item in os.listdir(cat_staging):
            ...
            if os.path.isdir(f_path):
                if os.path.exists(dest):
                    for sub in os.listdir(f_path): shutil.move(os.path.join(f_path, sub), os.path.join(dest, sub))
